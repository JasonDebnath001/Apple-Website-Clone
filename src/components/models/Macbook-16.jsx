...
Files: macbook-16.glb [639.28KB] > C:\Users\aritr\OneDrive\Desktop\apple\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // change the color if the part name is Not noChangeParts
